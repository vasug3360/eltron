...
<head>
    ...
    <title>ELTRON TURBO Original Imported Flexible Running Arrow Style Blinker Bright YELLOW & RED LED Indicators Universal For All Bike Models Motorcycle Turn Signal Lights (Pack of 4)</title>
        ...
        <main class="main mb-10 pb-1">
            ...
            <nav class="breadcrumb-nav container">
                <ul class="breadcrumb bb-no">
                    ...
                    <li>Flexible Running Arrow Style Blinker </li>
                </ul>
                        ...
                        <div class="main-content">
                            ...
                            <div class="col-md-12 mb-4 mb-md-6">
                                    <div class="product-details" data-sticky-options="{'minWidth': 767}">
                                        <h1 class="product-title">ELTRON TURBO Original Imported Flexible Running Arrow Style Blinker Bright YELLOW & RED LED Indicators Universal For All Bike Models Motorcycle Turn Signal Lights (Pack of 4) </h1>
                                        </div>
                                        </div>
                                            ...
                                            <div class="swiper-wrapper row cols-1 gutter-no">
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="assets/images/products/default/flexible-running-arrow-style-blinker/flexible-arrow-style-blinker-main.jpg"
                                                            data-zoom-image="assets/images/products/default/flexible-running-arrow-style-blinker/flexible-arrow-style-blinker-main.jpg"
                                                            alt="Led fog Light for Bike " width="800" height="900">
                                                    </figure>
                                                </div>
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="assets/images/products/default/flexible-running-arrow-style-blinker/flexible-arrow-style-blinker-1.jpg"
                                                            data-zoom-image="assets/images/products/default/flexible-running-arrow-style-blinker/flexible-arrow-style-blinker-1.jpg"
                                                            alt="" width="488" height="549">
                                                    </figure>
                                                </div>
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="assets/images/products/default/flexible-running-arrow-style-blinker/flexible-arrow-style-blinker-2.jpg"
                                                            data-zoom-image="assets/images/products/default/flexible-running-arrow-style-blinker/flexible-arrow-style-blinker-2.jpg"
                                                            alt="" width="800" height="900">
                                                    </figure>
                                                </div>
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="assets/images/products/default/flexible-running-arrow-style-blinker/flexible-arrow-style-blinker-3.jpg"
                                                            data-zoom-image="assets/images/products/default/flexible-running-arrow-style-blinker/flexible-arrow-style-blinker-3.jpg "
                                                            alt="" width="800" height="900">
                                                    </figure>
                                                </div>
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="assets/images/products/default/flexible-running-arrow-style-blinker/flexible-arrow-style-blinker-4.jpg"
                                                            data-zoom-image="assets/images/products/default/flexible-running-arrow-style-blinker/flexible-arrow-style-blinker-4.jpg"
                                                            alt="" width="800" height="900">
                                                    </figure>
                                                </div>
                                                ...
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="assets/images/products/default/flexible-running-arrow-style-blinker/flexible-arrow-style-blinker-5.jpg"
                                                            data-zoom-image="assets/images/products/default/flexible-running-arrow-style-blinker/flexible-arrow-style-blinker-5.jpg"
                                                            alt="" width="800" height="900">
                                                    </figure>
                                                </div>
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="assets/images/products/default/flexible-running-arrow-style-blinker/flexible-arrow-style-blinker-6.jpg"
                                                            data-zoom-image="assets/images/products/default/flexible-running-arrow-style-blinker/flexible-arrow-style-blinker-6.jpg"
                                                            alt="" width="800" height="900">
                                                    </figure>
                                                </div>
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="assets/images/products/default/flexible-running-arrow-style-blinker/flexible-arrow-style-blinker-7.jpg"
                                                            data-zoom-image="assets/images/products/default/flexible-running-arrow-style-blinker/flexible-arrow-style-blinker-7.jpg"
                                                            alt="" width="800" height="900">
                                                    </figure>
                                                </div>
                                                ...
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="assets/images/products/default/flexible-running-arrow-style-blinker/flexible-arrow-style-blinker-8.jpg"
                                                            data-zoom-image="assets/images/products/default/flexible-running-arrow-style-blinker/flexible-arrow-style-blinker-8.jpg"
                                                            alt="" width="800" height="900">
                                                    </figure>
                                                </div>
                                               </div>
                                ...
                                <div class="col-md-6 mb-4 mb-md-6">
                                    <div class="product-details" data-sticky-options="{'minWidth': 767}">
                                        ...
                                        <div class="product-price"><span>-45%</span> &nbsp;&nbsp;<ins class="new-price">&#8377;.549.00</ins><br> MRP.: <del class="old-price"> &#8377;.999.00</del></div>
                                        ...
                                        <div class="description-item">
                                                ...
                                                <li>Eltron Turbo Motorcycle Blue LED Turn Signal Indicators Light Lamp Regal Raptor 4Pcs 100% Brand New And High Quality Durable Product easy to use Made Of ABS Plastic Product description Easy install, durable Long lasting, low power consumption, energy saving Universal fit all motorcycles</li>
                                                    <li>Material : ABS Plastic</li>
                                                    <li>Body Color : Black</li>
                                                    <li>Led Light Color : Yellow</li>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="product-tab-description">
                                        <div class="row mb-4">
                                            ...
                                            <p class="mb-12">Eltron Turbo Motorcycle Blue LED Turn Signal Indicators Light Lamp Regal Raptor 4Pcs 100% Brand New And High Quality Durable Product easy to use Made Of ABS Plastic Product description Easy install, durable Long lasting, low power consumption, energy saving Universal fit all motorcycles.</p>
                                                <ul class="list-type-check">
                                                    <li>Eltron Turbo Motorcycle Blue LED Turn Signal Indicators Light Lamp Regal Raptor 4Pcs 100% Brand New And High Quality Durable Product easy to use Made Of ABS Plastic Product description Easy install, durable Long lasting, low power consumption, energy saving Universal fit all motorcycles</li>
                                                    <li>Material : ABS Plastic</li>
                                                    <li>Body Color : Black</li>
                                                    <li>Led Light Color : Yellow</li>
                                                    <li>Package Includes : 4xMotorcycle Turn Signal Lights</li>
                                                      </ul>
                                    ...
                                    <div class="tab-pane" id="product-tab-specification">
                                        <ul class="list-none">
                                            ...
                                            <li>
                                                ...
                                                <p>ELTRON TURBO Pack of 4 Original Imported Flexible Running Arrow Style Blinker Bright </p>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                ...
                                                <p>Pure YELLOW & RED LED ColourIndicators</p>
                                            </li>
