...
<head>
    ...
    <title>ELTRON TURBO Pack of 4 Blinker Bright YELLOW LED KTM Style Indicators for Universal All Bike Models Motorcycle Turn Signal Lights</title>
        ...
        <main class="main mb-10 pb-1">
            ...
            <nav class="breadcrumb-nav container">
                <ul class="breadcrumb bb-no">
                    ...
                    <li>KTM Style Universal Indicator</li>
                </ul>
                        ...
                        <div class="main-content">
                            ...
                            <div class="col-md-12 mb-4 mb-md-6">
                                    <div class="product-details" data-sticky-options="{'minWidth': 767}">
                                        <h1 class="product-title">ELTRON TURBO Pack of 4 Blinker Bright YELLOW LED KTM Style Indicators for Universal All Bike Models Motorcycle Turn Signal Lights</h1>
                                        </div>
                                        </div>
                                            ...
                                            <div class="swiper-wrapper row cols-1 gutter-no">
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="assets/images/products/default/ktm-style-universal-indicator/ktm-style-universal-indicator-main.jpg"
                                                            data-zoom-image="assets/images/products/default/ktm-style-universal-indicator/ktm-style-universal-indicator-main.jpg"
                                                            alt="Led fog Light for Bike " width="800" height="900">
                                                    </figure>
                                                </div>
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="assets/images/products/default/ktm-style-universal-indicator/ktm-style-universal-indicator-1.jpg"
                                                            data-zoom-image="assets/images/products/default/ktm-style-universal-indicator/ktm-style-universal-indicator-1.jpg"
                                                            alt="" width="488" height="549">
                                                    </figure>
                                                </div>
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="assets/images/products/default/ktm-style-universal-indicator/ktm-style-universal-indicator-2.jpg"
                                                            data-zoom-image="assets/images/products/default/ktm-style-universal-indicator/ktm-style-universal-indicator-2.jpg"
                                                            alt="" width="800" height="900">
                                                    </figure>
                                                </div>
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="assets/images/products/default/ktm-style-universal-indicator/ktm-style-universal-indicator-3.jpg"
                                                            data-zoom-image="assets/images/products/default/ktm-style-universal-indicator/ktm-style-universal-indicator-3.jpg "
                                                            alt="" width="800" height="900">
                                                    </figure>
                                                </div>
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="assets/images/products/default/ktm-style-universal-indicator/ktm-style-universal-indicator-4.jpg"
                                                            data-zoom-image="assets/images/products/default/ktm-style-universal-indicator/ktm-style-universal-indicator-4.jpg"
                                                            alt="" width="800" height="900">
                                                    </figure>
                                                </div>
                                                ...
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="assets/images/products/default/ktm-style-universal-indicator/ktm-style-universal-indicator-5.jpg"
                                                            data-zoom-image="assets/images/products/default/ktm-style-universal-indicator/ktm-style-universal-indicator-5.jpg"
                                                            alt="" width="800" height="900">
                                                    </figure>
                                                </div>
                                                </div>
                                ...
                                <div class="col-md-6 mb-4 mb-md-6">
                                    <div class="product-details" data-sticky-options="{'minWidth': 767}">
                                        ...
                                        <div class="product-price"><span>-45%</span> &nbsp;&nbsp;<ins class="new-price">&#8377;.229.00</ins><br> MRP.: <del class="old-price"> &#8377;.499.00</del></div>
                                    ...
                                    <div class="tab-pane" id="product-tab-specification">
                                        <ul class="list-none">
                                            ...
                                            <li>
                                                ...
                                                <p>ELTRON TURBO Pack of 4 Blinker Bright YELLOW LED KTM Style Indicators  </p>
                                            </li>
                                            <li>
