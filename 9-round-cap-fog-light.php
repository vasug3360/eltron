...
<head>
    ...
    <title>ELTRON TURBO 9 Round Cap LED Fog Light/Fog Lamp Waterproof Head Lamp Universal White Suitable For Bike, Car, Jeep, SUV, ATV, Mini Truck, Bus Helps Safe Ride in Poor Weather</title>
                        ...
                        <div class="main-content">
                            ...
                            <div class="col-md-12 mb-4 mb-md-6">
                                    <div class="product-details" data-sticky-options="{'minWidth': 767}">
                                        <h1 class="product-title">ELTRON TURBO 9 Round Cap LED Fog Light/Fog Lamp Waterproof Head Lamp Universal White Suitable For Bike, Car, Jeep, SUV, ATV, Mini Truck, Bus Helps Safe Ride in Poor Weather </h1>
                                        </div>
                                        </div>
                                    ...
                                    <div class="product-gallery product-gallery-sticky">
                                            ...
                                            <div class="swiper-wrapper row cols-1 gutter-no">
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="assets/images/products/default/Eletron-turbo-9-round-cap/eltron-turbo-9-round-cap-1.jpg"
                                                            data-zoom-image="assets/images/products/default/Eletron-turbo-9-round-cap/eltron-turbo-9-round-cap-1.jpg"
                                                            alt="Led fog Light for Bike " width="800" height="900">
                                                    </figure>
                                                </div>
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="assets/images/products/default/Eletron-turbo-9-round-cap/eltron-turbo-9-round-cap-3.jpg"
                                                            data-zoom-image="assets/images/products/default/Eletron-turbo-9-round-cap/eltron-turbo-9-round-cap-3.jpg"
                                                            alt="" width="488" height="549">
                                                    </figure>
                                                </div>
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="assets/images/products/default/Eletron-turbo-9-round-cap/eltron-turbo-9-round-cap-4.jpg"
                                                            data-zoom-image="assets/images/products/default/Eletron-turbo-9-round-cap/eltron-turbo-9-round-cap-4.jpg"
                                                            alt="" width="800" height="900">
                                                    </figure>
                                                </div>
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="assets/images/products/default/Eletron-turbo-9-round-cap/eltron-turbo-9-round-cap-5.jpg"
                                                            data-zoom-image="assets/images/products/default/Eletron-turbo-9-round-cap/eltron-turbo-9-round-cap-5.jpg "
                                                            alt="" width="800" height="900">
                                                    </figure>
                                                </div>
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="assets/images/products/default/Eletron-turbo-9-round-cap/eltron-turbo-9-round-cap-6.jpg"
                                                            data-zoom-image="assets/images/products/default/Eletron-turbo-9-round-cap/eltron-turbo-9-round-cap-6.jpg"
                                                            alt="" width="800" height="900">
                                                    </figure>
                                                </div>
                                               </div>
                                        ...
                                        <div class="product-thumbs-wrap swiper-container" data-swiper-options="{
                                            ...
                                            <div class="product-thumbs swiper-wrapper row cols-4 gutter-sm">
                                                ...
                                                <div class="product-thumb swiper-slide">
                                                    <img src="assets/images/products/default/Eletron-turbo-9-round-cap/eltron-turbo-9-round-cap-2.jpg"
                                                        alt="Product Thumb" width="800" height="900">
                                                </div>
                                                <div class="product-thumb swiper-slide">
                                                    <img src="assets/images/products/default/Eletron-turbo-9-round-cap/eltron-turbo-9-round-cap-3.jpg"
                                ...
                                <div class="col-md-6 mb-4 mb-md-6">
                                    <div class="product-details" data-sticky-options="{'minWidth': 767}">
                                        ...
                                        <div class="product-price"><span>-48%</span> &nbsp;&nbsp;<ins class="new-price">&#8377;.379.00</ins><br> MRP.: <del class="old-price"> &#8377;.699.00</del></div>
                                    ...
                                    <div class="tab-pane" id="product-tab-specification">
                                        <ul class="list-none">
                                            ...
                                            <li>
                                                ...
                                                <p>2 Pcs Of 9 Round CapLed Fog Light With 1 On/Off Switch</p>
                                            </li>
                                            <li>
