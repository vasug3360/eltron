...
<head>
    ...
    <title>ELTRON TURBO Paan Design Blinker Bright Amber Indicators Front Rear Lights Universal For All Bike Models Motorcycle Turn Signal Lights (Pack of 4)</title>
        ...
        <main class="main mb-10 pb-1">
            ...
            <nav class="breadcrumb-nav container">
                <ul class="breadcrumb bb-no">
                    ...
                    <li>Paan Style Led Indicator</li>
                </ul>
                        ...
                        <div class="main-content">
                            ...
                            <div class="col-md-12 mb-4 mb-md-6">
                                    <div class="product-details" data-sticky-options="{'minWidth': 767}">
                                        <h1 class="product-title">ELTRON TURBO Paan Design Blinker Bright Amber Indicators Front Rear Lights Universal For All Bike Models Motorcycle Turn Signal Lights (Pack of 4)</h1>
                                        </div>
                                        </div>
                                            ...
                                            <div class="swiper-wrapper row cols-1 gutter-no">
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="assets/images/products/default/paan-style-led-indicator/paan-style-led-indicator-main.jpg"
                                                            data-zoom-image="assets/images/products/default/paan-style-led-indicator/paan-style-led-indicator-main.jpg"
                                                            alt="Led fog Light for Bike " width="800" height="900">
                                                    </figure>
                                                </div>
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="assets/images/products/default/paan-style-led-indicator/paan-style-led-indicator-1.jpg"
                                                            data-zoom-image="assets/images/products/default/paan-style-led-indicator/paan-style-led-indicator-1.jpg"
                                                            alt="" width="488" height="549">
                                                    </figure>
                                                </div>
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="assets/images/products/default/paan-style-led-indicator/paan-style-led-indicator-2.jpg"
                                                            data-zoom-image="assets/images/products/default/paan-style-led-indicator/paan-style-led-indicator-2.jpg"
                                                            alt="" width="800" height="900">
                                                    </figure>
                                                </div>
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="assets/images/products/default/paan-style-led-indicator/paan-style-led-indicator-3.jpg"
                                                            data-zoom-image="assets/images/products/default/paan-style-led-indicator/paan-style-led-indicator-3.jpg "
                                                            alt="" width="800" height="900">
                                                    </figure>
                                                </div>
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="assets/images/products/default/paan-style-led-indicator/paan-style-led-indicator-4.jpg"
                                                            data-zoom-image="assets/images/products/default/paan-style-led-indicator/paan-style-led-indicator-4.jpg"
                                                            alt="" width="800" height="900">
                                                    </figure>
                                                </div>
                                                ...
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="assets/images/products/default/paan-style-led-indicator/paan-style-led-indicator-5.jpg"
                                                            data-zoom-image="assets/images/products/default/paan-style-led-indicator/paan-style-led-indicator-5.jpg"
                                                            alt="" width="800" height="900">
                                                    </figure>
                                                </div>
                                                ...
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="assets/images/products/default/paan-style-led-indicator/paan-style-led-indicator-6.jpg"
                                                            data-zoom-image="assets/images/products/default/paan-style-led-indicator/paan-style-led-indicator-6.jpg"
                                                            alt="" width="800" height="900">
                                                    </figure>
                                                </div>
                                                  </div>
                                ...
                                <div class="col-md-6 mb-4 mb-md-6">
                                    <div class="product-details" data-sticky-options="{'minWidth': 767}">
                                        ...
                                        <div class="product-price"><span>-45%</span> &nbsp;&nbsp;<ins class="new-price">&#8377;.249.00</ins><br> MRP.: <del class="old-price"> &#8377;.499.00</del></div>
                                    ...
                                    <div class="tab-pane" id="product-tab-specification">
                                        <ul class="list-none">
                                            ...
                                            <li>
                                                ...
                                                <p>ELTRON TURBO Paan Design Blinker Bright Dual Color Indicators </p>
                                            </li>
                                            <li>
