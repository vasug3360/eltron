...
<head>
    ...
    <title>ELTRON TURBO Original Imported Flexible Pack of 4 Running Style Blinker Bright YELLOW & BLUE LED Indicators Universal For All Bike Models Motorcycle Turn Signal Lights</title>
        ...
        <main class="main mb-10 pb-1">
            ...
            <nav class="breadcrumb-nav container">
                <ul class="breadcrumb bb-no">
                    ...
                    <li>Flexible Pack of 4 Running Style Blinker Bright Yellow & Blue Led </li>
                </ul>
                        ...
                        <div class="main-content">
                            ...
                            <div class="col-md-12 mb-4 mb-md-6">
                                    <div class="product-details" data-sticky-options="{'minWidth': 767}">
                                        <h1 class="product-title">ELTRON TURBO Original Imported Flexible Pack of 4 Running Style Blinker Bright YELLOW & BLUE LED Indicators Universal For All Bike Models Motorcycle Turn Signal Lights</h1>
                                        </div>
                                        </div>
                                            ...
                                            <div class="swiper-wrapper row cols-1 gutter-no">
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="assets/images/products/default/flexible-pack-4-srunning-style-blinker/4-runiing-style-blinker-ellow-blue-main.jpg"
                                                            data-zoom-image="assets/images/products/default/flexible-pack-4-srunning-style-blinker/4-runiing-style-blinker-ellow-blue-main.jpg"
                                                            alt="Led fog Light for Bike " width="800" height="900">
                                                    </figure>
                                                </div>
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="assets/images/products/default/flexible-pack-4-srunning-style-blinker/4-runiing-style-blinker-ellow-blue-1.jpg"
                                                            data-zoom-image="assets/images/products/default/flexible-pack-4-srunning-style-blinker/4-runiing-style-blinker-ellow-blue-1.jpg"
                                                            alt="" width="488" height="549">
                                                    </figure>
                                                </div>
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="assets/images/products/default/flexible-pack-4-srunning-style-blinker/4-runiing-style-blinker-ellow-blue-2.jpg"
                                                            data-zoom-image="assets/images/products/default/flexible-pack-4-srunning-style-blinker/4-runiing-style-blinker-ellow-blue-2.jpg"
                                                            alt="" width="800" height="900">
                                                    </figure>
                                                </div>
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="assets/images/products/default/flexible-pack-4-srunning-style-blinker/4-runiing-style-blinker-ellow-blue-3.jpg"
                                                            data-zoom-image="assets/images/products/default/flexible-pack-4-srunning-style-blinker/4-runiing-style-blinker-ellow-blue-3.jpg "
                                                            alt="" width="800" height="900">
                                                    </figure>
                                                </div>
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="assets/images/products/default/flexible-pack-4-srunning-style-blinker/4-runiing-style-blinker-ellow-blue-4.jpg"
                                                            data-zoom-image="assets/images/products/default/flexible-pack-4-srunning-style-blinker/4-runiing-style-blinker-ellow-blue-4.jpg"
                                                            alt="" width="800" height="900">
                                                    </figure>
                                                </div>
                                                  </div>
                                ...
                                <div class="col-md-6 mb-4 mb-md-6">
                                    <div class="product-details" data-sticky-options="{'minWidth': 767}">
                                        ...
                                        <div class="product-price"><span>-45%</span> &nbsp;&nbsp;<ins class="new-price">&#8377;.449.00</ins><br> MRP.: <del class="old-price"> &#8377;.899.00</del></div>
                                    ...
                                    <div class="tab-pane" id="product-tab-specification">
                                        <ul class="list-none">
                                            ...
                                            <li>
                                                ...
                                                <p>ELTRON TURBO Pack of 4 Original Imported Flexible Running Style Blinker Bright </p>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                ...
                                                <p>Pure YELLOW & BLUE LED ColourIndicators</p>
                                            </li>
