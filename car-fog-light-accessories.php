...
<head>
    ...
    <title>Eltron Turbo | Bike Accessories Fog Light </title>
        ...
        <main class="main">
            ...
            <div class="page-content mb-10">
                <div class="shop-default-banner shop-boxed-banner banner d-flex align-items-center mb-6"
                    style="background-image: url(assets/images/shop/bike-fog-light-accessories.jpg); background-color: #FFC74E;">
                    <div class="container banner-content">
                        <h4 class="banner-subtitle font-weight-bold">Accessories Collection</h4>
                        <h3 class="banner-title text-white text-uppercase font-weight-bolder ls-10">Bikes Fog Light</h3>
                            ...
                            <div class="product-wrapper row cols-xl-8 cols-lg-6 cols-md-4 cols-sm-3 cols-2">
                                <div class="product-wrap">
                                    <div class="product text-center">
                                        <figure class="product-media">
                                            <a href="#">
                                                <img src="assets/images/shop/mini-driving-fog-light.jpg" alt="Mini Driving Fog Light" title="Mini Driving Fog Light" width="300"
                                                    height="338" />
                                            </a>
                                        ...
                                        <div class="product-details">
                                            ...
                                            <h3 class="product-name">
                                                <a href="#">Mini Driving Fog Light</a>
                                            </h3>
                                    ...
                                    <div class="product text-center">
                                        <figure class="product-media">
                                            <a href="product-default.html">
                                                <img src="assets/images/shop/6-led-fog-light.jpg" alt="Product" width="300"
                                                    height="338" />
                                ...
                                <div class="product-wrap">
                                    <div class="product text-center">
                                        <figure class="product-media">
                                            <a href="product-default.html">
                                                <img src="assets/images/shop/6-led-fog-light-1.jpg" alt="Product" width="300"
                                                    height="338" />
                                            </a>
                                            <div class="product-action-horizontal">
                                                <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                ...
                                <div class="product-wrap">
                                    <div class="product text-center">
                                        <figure class="product-media">
                                            <a href="product-default.html">
                                                <img src="assets/images/shop/9-led-fog-light.jpg" alt="Product" width="300"
                                                    height="338" />
                                            </a>
                                            <div class="product-action-horizontal">
                                                <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                ...
                                <div class="product-wrap">
                                    <div class="product text-center">
                                        <figure class="product-media">
                                            <a href="product-default.html">
                                                <img src="assets/images/shop/9-led-round-cap-fog-light.jpg" alt="Product" width="300"
                                                    height="338" />
                                            </a>
                                            <div class="product-action-horizontal">
                                                <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                        ...
                                        <div class="product-details">
                                            ...
                                            <h3 class="product-name">
                                                <a href="#">9 Led Round Cap Fog Light</a>
                                            </h3>
                                            <div class="ratings-container">
                                                <div class="ratings-full">
                                                    <span class="ratings" style="width: 80%;"></span>
