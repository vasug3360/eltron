...
<head>
    ...
    <title>ELTRON TURBO Pack of 4 Arrow Style Blinker Bright YELLOW & BLUE LED Indicators Universal For All Bike Models Motorcycle Turn Signal Lights</title>
                        ...
                        <div class="main-content">
                            ...
                            <div class="col-md-12 mb-4 mb-md-6">
                                    <div class="product-details" data-sticky-options="{'minWidth': 767}">
                                        <h1 class="product-title">ELTRON TURBO Pack of 4 Arrow Style Blinker Bright YELLOW & BLUE LED Indicators Universal For All Bike Models Motorcycle Turn Signal Lights</h1>
                                        </div>
                                        </div>
                                            ...
                                            <div class="swiper-wrapper row cols-1 gutter-no">
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="assets/images/products/default/arrow-style-indicator/arrow-style-indicator-main.jpg"
                                                            data-zoom-image="assets/images/products/default/arrow-style-indicator/arrow-style-indicator-main.jpg"
                                                            alt="Led fog Light for Bike " width="800" height="900">
                                                    </figure>
                                                </div>
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="assets/images/products/default/arrow-style-indicator/arrow-style-indicator-1.jpg"
                                                            data-zoom-image="assets/images/products/default/arrow-style-indicator/arrow-style-indicator-1.jpg"
                                                            alt="" width="488" height="549">
                                                    </figure>
                                                </div>
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="assets/images/products/default/arrow-style-indicator/arrow-style-indicator-2.jpg"
                                                            data-zoom-image="assets/images/products/default/arrow-style-indicator/arrow-style-indicator-2.jpg"
                                                            alt="" width="800" height="900">
                                                    </figure>
                                                </div>
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="assets/images/products/default/arrow-style-indicator/arrow-style-indicator-3.jpg"
                                                            data-zoom-image="assets/images/products/default/arrow-style-indicator/arrow-style-indicator-3.jpg "
                                                            alt="" width="800" height="900">
                                                    </figure>
                                                </div>
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="assets/images/products/default/arrow-style-indicator/arrow-style-indicator-4.jpg"
                                                            data-zoom-image="assets/images/products/default/arrow-style-indicator/arrow-style-indicator-4.jpg"
                                                            alt="" width="800" height="900">
                                                    </figure>
                                                </div>
                                                ...
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="assets/images/products/default/arrow-style-indicator/arrow-style-indicator-5.jpg"
                                                            data-zoom-image="assets/images/products/default/arrow-style-indicator/arrow-style-indicator-5.jpg"
                                                            alt="" width="800" height="900">
                                                    </figure>
                                                </div>
                                                ...
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="assets/images/products/default/arrow-style-indicator/arrow-style-indicator-6.jpg"
                                                            data-zoom-image="assets/images/products/default/arrow-style-indicator/arrow-style-indicator-6.jpg"
                                                            alt="" width="800" height="900">
                                                    </figure>
                                                </div>
                                                ...
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="assets/images/products/default/arrow-style-indicator/arrow-style-indicator-7.jpg"
                                                            data-zoom-image="assets/images/products/default/arrow-style-indicator/arrow-style-indicator-7.jpg"
                                                            alt="" width="800" height="900">
                                                    </figure>
                                                </div>
                                                 </div>
                                ...
                                <div class="col-md-6 mb-4 mb-md-6">
                                    <div class="product-details" data-sticky-options="{'minWidth': 767}">
                                        ...
                                        <div class="product-price"><span>-45%</span> &nbsp;&nbsp;<ins class="new-price">&#8377;.299.00</ins><br> MRP.: <del class="old-price"> &#8377;.699.00</del></div>
                                    ...
                                    <div class="tab-pane" id="product-tab-specification">
                                        <ul class="list-none">
                                            ...
                                            <li>
                                                ...
                                                <p>ELTRON TURBO Pack of 4 Arrow Style Blinker Bright Indicators </p>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                ...
                                                <p>Pure Amber YELLOW & BLUE LED Color</p>
                                            </li>
