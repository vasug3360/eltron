...
<head>
    ...
    <title>Eltron Turbo | Contact Us</title>
                ...
                <div class="container">
                    ...
                    <section class="contact-information-section mb-10">
                        <div class=" swiper-container swiper-theme " data-swiper-options="{
                            ...
                            <div class="swiper-wrapper row cols-md-4" align="center">
                                <div class="swiper-slide icon-box text-center icon-box-primary">
                                    <span class="icon-box-icon icon-email">
                                        <i class="w-icon-envelop-closed"></i>
                                    </span>
                                    <div class="icon-box-content" align="center">
                                        <h4 class="icon-box-title">E-mail Address</h4>
                                        <p>eltronturbo141@gmail.com</p>
                                    </div>
                                </div>
                                <div class="swiper-slide icon-box text-center icon-box-primary">
                                    ...
                                    <div class="icon-box-content" align="center">
                                        ...
                                        <p>9811599668-Honey / 9811252210-Harsh</p> <br>
                                        <p>9953944225-Shivay</p>
                                    </div>
                                </div>
                                <div class="swiper-slide icon-box text-center icon-box-primary">
                                    ...
                                    <div class="icon-box-content" align="center">
                                        ...
                                        <p>107 four story, Tagore Garden, New Delhi, Delhi 110027</p>
                                    </div>
                                </div>
...
<!-- Mirrored from portotheme.com/html/wolmart/contact-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 04 Feb 2022 05:36:58 GMT -->
</html>