...
<head>
    ...
    <title>ELTRON TURBO 6 Led Blinker Bright Amber Indicators Front Rear Lights Universal For All Bike Models Motorcycle Turn Signal Lights (Pack of 4)</title>
                        ...
                        <div class="main-content">
                            ...
                            <div class="col-md-12 mb-4 mb-md-6">
                                    <div class="product-details" data-sticky-options="{'minWidth': 767}">
                                        <h1 class="product-title">ELTRON TURBO 6 Led Blinker Bright Amber Indicators Front Rear Lights Universal For All Bike Models Motorcycle Turn Signal Lights (Pack of 4)</h1>
                                        </div>
                                        </div>
                                            ...
                                            <div class="swiper-wrapper row cols-1 gutter-no">
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="assets/images/products/default/6-led-style-indicator/6-led-style-indicator-main.jpg"
                                                            data-zoom-image="assets/images/products/default/6-led-style-indicator/6-led-style-indicator-main.jpg"
                                                            alt="Led fog Light for Bike " width="800" height="900">
                                                    </figure>
                                                </div>
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="assets/images/products/default/6-led-style-indicator/6-led-style-indicator-1.jpg"
                                                            data-zoom-image="assets/images/products/default/6-led-style-indicator/6-led-style-indicator-1.jpg"
                                                            alt="" width="488" height="549">
                                                    </figure>
                                                </div>
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="assets/images/products/default/6-led-style-indicator/6-led-style-indicator-2.jpg"
                                                            data-zoom-image="assets/images/products/default/6-led-style-indicator/6-led-style-indicator-2.jpg"
                                                            alt="" width="800" height="900">
                                                    </figure>
                                                </div>
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="assets/images/products/default/6-led-style-indicator/6-led-style-indicator-3.jpg"
                                                            data-zoom-image="assets/images/products/default/6-led-style-indicator/6-led-style-indicator-3.jpg "
                                                            alt="" width="800" height="900">
                                                    </figure>
                                                </div>
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="assets/images/products/default/6-led-style-indicator/6-led-style-indicator-4.jpg"
                                                            data-zoom-image="assets/images/products/default/6-led-style-indicator/6-led-style-indicator-4.jpg"
                                                            alt="" width="800" height="900">
                                                    </figure>
                                                </div>
                                                ...
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="assets/images/products/default/6-led-style-indicator/6-led-style-indicator-5.jpg"
                                                            data-zoom-image="assets/images/products/default/6-led-style-indicator/6-led-style-indicator-5.jpg"
                                                            alt="" width="800" height="900">
                                                    </figure>
                                                </div>
                                                 </div>
                                ...
                                <div class="col-md-6 mb-4 mb-md-6">
                                    <div class="product-details" data-sticky-options="{'minWidth': 767}">
                                        ...
                                        <div class="product-price"><span>-45%</span> &nbsp;&nbsp;<ins class="new-price">&#8377;.269.00</ins><br> MRP.: <del class="old-price"> &#8377;.599.00</del></div>
                                    ...
                                    <div class="tab-pane" id="product-tab-specification">
                                        <ul class="list-none">
                                            ...
                                            <li>
                                                ...
                                                <p>ELTRON TURBO D Shaped Style Blinker Bright Dual Color Indicators </p>
                                            </li>
                                            <li>
