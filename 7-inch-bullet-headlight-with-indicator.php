...
<head>
    ...
    <title>ELTRON TURBO 7 Inch LED Headlight with Indicator Compatible DRL White and Yellow, Angel Eye Lamp Compatible for all Thar& Bullet Models, Hi/Low Beam Amber</title>
        ...
        <main class="main mb-10 pb-1">
            ...
            <nav class="breadcrumb-nav container">
                <ul class="breadcrumb bb-no">
                    ...
                    <li>7 Inch Bullet Headlight with Indicator Compatible</li>
                </ul>
                        ...
                        <div class="main-content">
                            ...
                            <div class="col-md-12 mb-4 mb-md-6">
                                    <div class="product-details" data-sticky-options="{'minWidth': 767}">
                                        <h1 class="product-title">ELTRON TURBO 7 Inch LED Headlight with Indicator Compatible DRL White and Yellow, Angel Eye Lamp Compatible for all Thar& Bullet Models, Hi/Low Beam Amber</h1>
                                        </div>
                                        </div>
                                            ...
                                            <div class="swiper-wrapper row cols-1 gutter-no">
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="assets/images/products/default/7-inch-bullet-headlight-with-indicator/7-inch-bullet-headlight-main.jpg"
                                                            data-zoom-image="assets/images/products/default/7-inch-bullet-headlight-with-indicator/7-inch-bullet-headlight-main.jpg"
                                                            alt="Led fog Light for Bike " width="800" height="900">
                                                    </figure>
                                                </div>
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="assets/images/products/default/7-inch-bullet-headlight-with-indicator/7-inch-bullet-headlight-1.jpg"
                                                            data-zoom-image="assets/images/products/default/7-inch-bullet-headlight-with-indicator/7-inch-bullet-headlight-1.jpg"
                                                            alt="" width="488" height="549">
                                                    </figure>
                                                </div>
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="assets/images/products/default/7-inch-bullet-headlight-with-indicator/7-inch-bullet-headlight-2.jpg"
                                                            data-zoom-image="assets/images/products/default/7-inch-bullet-headlight-with-indicator/7-inch-bullet-headlight-2.jpg"
                                                            alt="" width="800" height="900">
                                                    </figure>
                                                </div>
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="assets/images/products/default/7-inch-bullet-headlight-with-indicator/7-inch-bullet-headlight-3.jpg"
                                                            data-zoom-image="assets/images/products/default/7-inch-bullet-headlight-with-indicator/7-inch-bullet-headlight-3.jpg"
                                                            alt="" width="800" height="900">
                                                    </figure>
                                                </div>
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="assets/images/products/default/7-inch-bullet-headlight-with-indicator/7-inch-bullet-headlight-4.jpg"
                                                            data-zoom-image="assets/images/products/default/7-inch-bullet-headlight-with-indicator/7-inch-bullet-headlight-4.jpg"
                                                            alt="" width="800" height="900">
                                                    </figure>
                                                </div>
                                                ...
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="assets/images/products/default/7-inch-bullet-headlight-with-indicator/7-inch-bullet-headlight-5.jpg"
                                                            data-zoom-image="assets/images/products/default/7-inch-bullet-headlight-with-indicator/7-inch-bullet-headlight-5.jpg"
                                                            alt="" width="800" height="900">
                                                    </figure>
                                                </div>
                                                ...
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="assets/images/products/default/7-inch-bullet-headlight-with-indicator/7-inch-bullet-headlight-6.jpg"
                                                            data-zoom-image="assets/images/products/default/7-inch-bullet-headlight-with-indicator/7-inch-bullet-headlight-6.jpg"
                                                            alt="" width="800" height="900">
                                                    </figure>
                                                </div>
                                    ...
                                    <div class="tab-pane active" id="product-tab-description">
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-md-12 mb-5">
                                                ...
                                                <p class="mb-12"> ELTRON TURBO 7 Inch LED Headlight with Indicator Compatible DRL White and YellowHi/Low Beam and Angel Eye Lamp For Bullet Classic 350/500cc, Standard 350/500cc and Electra 350cc,Thar</p>
        ...
        <div class="row gutter-lg">
            ...
            <div class="col-md-6 overflow-hidden p-relative">
                <div class="product-details scrollable pl-0">
                    ...
                    <div class="product-bm-wrapper">
                        <figure class="brand">
                            <img src="assets/images/brands/category/eltron-turbo.png" alt="Brand" width="102" height="48" />
                        </figure>
                        <div class="product-meta">
                            <div class="product-categories">
                                Category:
